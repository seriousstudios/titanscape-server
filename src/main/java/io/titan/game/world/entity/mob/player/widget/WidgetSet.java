package io.titan.game.world.entity.mob.player.widget;
...
import io.titan.net.packet.out.DisplayInventoryWidgetPacket;
import io.titan.net.packet.out.DisplayWidgetPacket;
