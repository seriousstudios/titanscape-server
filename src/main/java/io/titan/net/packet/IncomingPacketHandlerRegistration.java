...
import io.titan.net.packet.in.AppearanceChangePacket;
import io.titan.net.packet.in.AttackNpcPacket;
import io.titan.net.packet.in.ButtonClickPacket;
import io.titan.net.packet.in.ChatMessagePacket;
import io.titan.net.packet.in.CloseInterfacePacket;
import io.titan.net.packet.in.CommandPacket;
import io.titan.net.packet.in.DefaultPacket;
import io.titan.net.packet.in.DialoguePacket;
import io.titan.net.packet.in.DropItemPacket;
import io.titan.net.packet.in.EnterRegionPacket;
import io.titan.net.packet.in.EquipItemPacket;
import io.titan.net.packet.in.IdleLogoutPacket;
import io.titan.net.packet.in.ItemFirstOptionPacket;
import io.titan.net.packet.in.ItemOnGroundItemPacket;
import io.titan.net.packet.in.ItemOnItemPacket;
import io.titan.net.packet.in.ItemOnNpcPacket;
import io.titan.net.packet.in.ItemOnObjectPacket;
import io.titan.net.packet.in.ItemOnPlayerPacket;
import io.titan.net.packet.in.ItemSecondOptionPacket;
import io.titan.net.packet.in.ItemThirdOptionPacket;
import io.titan.net.packet.in.LoadRegionPacket;
import io.titan.net.packet.in.MagicOnFloorItemPacket;
import io.titan.net.packet.in.MagicOnItemPacket;
import io.titan.net.packet.in.MagicOnNpcPacket;
import io.titan.net.packet.in.MagicOnObjectPacket;
import io.titan.net.packet.in.MagicOnPlayerPacket;
import io.titan.net.packet.in.MoveItemPacket;
import io.titan.net.packet.in.MovementPacket;
import io.titan.net.packet.in.NpcFirstClickPacket;
import io.titan.net.packet.in.NpcSecondClickPacket;
import io.titan.net.packet.in.NpcThirdClickPacket;
import io.titan.net.packet.in.ObjectFirstOptionPacket;
import io.titan.net.packet.in.ObjectSecondOptionPacket;
import io.titan.net.packet.in.ObjectThirdOptionPacket;
import io.titan.net.packet.in.PickupGroundItemPacket;
import io.titan.net.packet.in.PlayerFifthOptionPacket;
import io.titan.net.packet.in.PlayerFirstOptionPacket;
import io.titan.net.packet.in.PlayerFourthOptionPacket;
import io.titan.net.packet.in.PlayerRelationPacket;
import io.titan.net.packet.in.PlayerSecondOptionPacket;
import io.titan.net.packet.in.PlayerThirdOptionPacket;
import io.titan.net.packet.in.ReportPlayerPacket;
import io.titan.net.packet.in.TradeAnswerPacket;
import io.titan.net.packet.in.TypeOnWidgetPacket;
import io.titan.net.packet.in.WidgetContainerFifthOptionPacket;
import io.titan.net.packet.in.WidgetContainerFirstOptionPacket;
import io.titan.net.packet.in.WidgetContainerFourthOptionPacket;
import io.titan.net.packet.in.WidgetContainerSecondOptionPacket;
import io.titan.net.packet.in.WidgetContainerSixthOptionPacket;
import io.titan.net.packet.in.WidgetContainerThirdOptionPacket;
